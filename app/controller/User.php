...
class User extends Base
{
     ...
     * @Apidoc\Title("获取用户列表")
     * @Apidoc\Method("POST")
     * @Apidoc\Param("page", type="numberic",require=false, desc="页码")
     * @Apidoc\Param("limit", type="numberic",require=false, desc="条数")
     * @Apidoc\Param("user_name", type="string",require=false, desc="用户名")
     * @Apidoc\Param("phone", type="string",require=false, desc="手机号")
     * @Apidoc\Param("market_uid", type="string",require=false, desc="market_uid")
     * @Apidoc\Param("type", type="numberic",require=true, desc="type")
     * @Apidoc\Param("agent_name", type="string",require=true, desc="agent_name")
     * @Apidoc\Param("start", type="string",require=true, desc="start")
     * @Apidoc\Param("end", type="numberic",require=true, desc="end")
