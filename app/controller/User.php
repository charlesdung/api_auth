...
class User extends Base
{
     ...
     * @Apidoc\Title("获取用户列表")
     * @Apidoc\Method("POST")
     * @Apidoc\Url("/user/list")
     * @Apidoc\Param("page", type="int",require=false,default="1", desc="页码")
     * @Apidoc\Param("limit", type="int",require=false, default="10",desc="条数")
     ...
     * @Apidoc\Param("type", type="int",require=true,default="2", desc="type")
     * @Apidoc\Param("is_fictitious", type="string",require=true,default="3", desc="")
     * @Apidoc\Param("start", type="string",require=true,default="", desc="start")
     * @Apidoc\Param("end", type="int",require=true,default="", desc="end")
