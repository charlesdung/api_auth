...
class GameName extends Base
{
     ...
     * @Apidoc\Title("游戏添加")
     * @Apidoc\Method("POST")
     * @Apidoc\Url("/gamename/add")
     * @Apidoc\Param("type_name", type="string",require=true, desc="游戏名称")
     * @Apidoc\Param("status", type="int",require=true, desc="状态")
     * @Apidoc\Param("explain", type="text",require=false, desc="说明")
     * @Apidoc\Returned("data", type="bool", desc="返回成功失败结果")
     */
    public function add()
    {
     ...
     * @Apidoc\Title("游戏编辑")
     * @Apidoc\Method("POST")
     * @Apidoc\Url("/gamename/edit")
     * @Apidoc\Param("id", type="int",require=true, desc="游戏id")
     * @Apidoc\Param("type_name", type="string",require=true, desc="游戏名称")
     * @Apidoc\Param("status", type="int",require=true, desc="状态")
     * @Apidoc\Param("explain", type="text",require=false, desc="说明")
     * @Apidoc\Returned("data", type="bool", desc="返回成功失败结果")
