...
class Luzhu extends Base
{
     ...
     * @Apidoc\Title("露珠添加")
     * @Apidoc\Method("POST")
     * @Apidoc\Url("/luzhu/add")
     * @Apidoc\Param("status", type="int",require=true, desc="状态")
     * @Apidoc\Param("table_id", type="string",require=true, desc="台桌id")
     * @Apidoc\Param("game_type", type="string",require=true, desc="台桌类型")
     * @Apidoc\Param("result", type="int",require=true, desc="结果")
     * @Apidoc\Param("result_pai", type="string",require=true, desc="具体的开牌数字")
     * @Apidoc\Param("xue_number", type="string",require=true, desc="靴号")
     * @Apidoc\Param("pu_number", type="string",require=true, desc="铺号")
     * @Apidoc\Returned("data", type="bool", desc="返回成功失败结果")
     */
    public function add()
    {
     ...
     * @Apidoc\Method("POST")
     * @Apidoc\Url("/luzhu/add")
     * @Apidoc\Param("id", type="int",require=true, desc="露珠列表的id")
     * @Apidoc\Param("status", type="int",require=true, desc="状态")
     * @Apidoc\Param("table_id", type="string",require=true, desc="台桌id")
     * @Apidoc\Param("game_type", type="string",require=true, desc="台桌类型")
     * @Apidoc\Param("result", type="int",require=true, desc="结果")
